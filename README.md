...
### 2.93
* CHANGED: Remove screen_icon from SCB

### 2.92
* NEW: Add title attr to pages link. Props @Mahjouba91

### 2.91
* NEW: Validate text option against kses
* CHANGED: Update SCB Framework

### 2.90
* CHANGED: Remove po/mo files from the plugin
* CHANGED: Use translate.wordpress.org to translate the plugin
...
### 2.83
* NEW: Added 'echo' parameter
* NEW: Added Estonian and Bengali translations
* CHANGED: Updated scbFramework

### 2.82
* NEW: Added Hebrew, Georgian and Azerbaijani translations
* CHANGED: Updated scbFramework
* FIXED: Prev/next links not appearing in some conditions

### 2.81
* CHANGED: Require an explicit type; fixes bugs with multipart pages

### 2.80
* NEW: Support for multi-part pages and user queries
* CHANGED: Moved prev/next links before/after first/last links

### 2.74
* NEW: Added 'smaller' and 'larger' classes
* NEW: Added $query arg to wp_pagenavi()
